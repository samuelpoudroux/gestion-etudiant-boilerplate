...
function studentscreen() {
    ...
    studentlist.forEach(student => {
        if (student.promotion == mySelect.value) {
            ...
            // I create each button that is allow us to alter the students items by seetinf an id and dataset-id in ordr to get back the right input later into the function alterstudent
